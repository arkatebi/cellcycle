...
#HEADER_1_STATES =["MODEL_NO","MODEL_NO", "MODEL_NO"]
...
class Network: 
    def __init__(self,WORK_DIR):
        ...
        self.fname_dict_nodeparams['mpr']=self.work_dir+'/'+fn_prefix+".mpr.exp.txt"
        self.fname_dict_nodeparams['dnr']=self.work_dir+'/'+fn_prefix+".dnr.exp.txt"

        self.fname_dict_edgeparams=OrderedDict()
        self.fname_dict_edgeparams['tsh']=self.work_dir+'/'+fn_prefix+".tsh.exp.txt"
        self.fname_dict_edgeparams['hco']=self.work_dir+'/'+fn_prefix+".hco.exp.txt"
        self.fname_dict_edgeparams['fch']=self.work_dir+'/'+fn_prefix+".fch.exp.txt"
    ...
    #------------------------------------------------------------------#
    def get_fname_states_act(self):
        return self.fname_states_act
